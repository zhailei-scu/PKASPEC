...
public:
	...
	void Cal_MinDist_LinkedCell(std::map<int, std::vector<TrackInfo>>* storedData,double boundary[][2], int ceilingNum_OneDim, std::fstream* ofsAnalysisPath_DistanceXYZ, std::fstream *ofsAnalysisPath_DistanceXYZ_ZONE);
